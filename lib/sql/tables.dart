class TablesV1 {
  static String USERS =
      'CREATE TABLE users(id integer primary key,user_id text, user_type_id text, distributor_id text, user_first_name text, user_last_name text, user_email_address text, user_password text, user_phone_number text, user_mobile text, user_status text, login_status integer, discount_percent text, createdon text, modifiedon text)';

  static String USERSTYPES =
      'CREATE TABLE users_types(id integer primary key, user_type_id text, user_type_title text, user_type_permissions text)';

  static String CATEGORIES =
      'CREATE TABLE categories(id integer primary key, product_category_id text, user_id text, product_category_title text, product_category_image text, createdon text, modifiedon text)';
  ...
  static String PAID_INVOICES =
      'CREATE TABLE paid_invoices(id integer primary key, payment_user_id text, payment_order_id text, payment_invoice_id text, payment_customer_id text, payment_amount text, payment_mode text, payment_cheque_no text, payment_clearing_date text, payment_bank_name text, date_added text, is_upload integer)';
  ...
  static String VISITS =
      'CREATE TABLE visits(id integer primary key, customer_id text, user_id text, lat text, long text, isorder text, createdon text, is_upload integer, pair_id integer, order_id text)';
  ...
  static String DROP_CATEGORY_PERMISSIONS =
