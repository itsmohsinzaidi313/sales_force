class Select {
  static String selectUser =
      'select user_id, user_type_id, distributor_id, user_first_name, user_last_name, user_email_address, user_password, user_phone_number, user_mobile, user_status, createdon, modifiedon, discount_percent, user_type_id from users ';

  static String selectUserTypes =
      'select user_type_id, user_type_title, user_type_permissions from users_types ';

  static String selectCategories =
      'select distinct product_category_id, b.user_id, product_category_title, product_category_image, createdon, modifiedon from Categories a left join category_permissions b on b.category_id = a.product_category_id ';

  static String selectProducts =
  ...
  static String selectOrderMaster =
      'select id as order_android_id, user_id, customer_id, order_amount, order_discount, order_total, order_status, order_delivery_date, createdon, spo_discount from order_master ';
  ...
  static String selectOrderLocation =
      'select id as order_taken_android_id, customer_id as order_taken_customer_id, user_id as order_taken_visit_admin_users_id_parcosf, lat as order_taken_visit_lat, long as order_taken_visit_long, isorder as order_taken_visit_isorder, createdon as order_taken_visit_createdon, order_id from visits';
